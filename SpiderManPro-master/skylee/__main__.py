...
Any issues or need help related to me? join our group [Spider Support Chat 💬](https://t.me/SpiderBotSupport).
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group 👥", url="t.me/SpiderMan_ProBot?startgroup=true"
        ),
        InlineKeyboardButton(text="Updates 📢", url="https://t.me/SpiderBotSupport"),
    ]
]
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://telegra.ph/SpiderMan-ProBot-07-27",
                PM_START_TEXT,
